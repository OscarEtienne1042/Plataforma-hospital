...
<html lang="en">
    <head>
      <title>Recepcionista | Consulta general</title>
      <meta charset="UTF-8">
    ...
    <body>
      <header>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item nav-item active" href="consultasPaciente.php">Consultas generales</a>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(./img/fondThree.jpg);">
                <h1>Consulta general</h1>
                <p>La mejor atención a la comunidad..</p>
                <form action="consultasPacienteI.php">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mt-2">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo $fila['CURP']."<br> Telefono: ".$fila['Telefono_contacto']."<br> Sexo: ".$fila['Sexo']."<br> Edad: ".$fila['Edad']?></p>
