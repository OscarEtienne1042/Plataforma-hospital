...
<html lang="en">
    ...
    <body>
      <header>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item nav-item active" href="consultasRecepcionistaI.php">Consultas individuales</a>
                  <!--
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#">Something else here</a>-->
                </div>
        ...
        <div class="cover d-flex justify-content-center align-items-center flex-column" style="background-image: url(./img/fondNine.jpg);">
            ...
            <div class="row justify-content-right">
                <?php
                    if(isset($_GET['enviar'])){
                        ...
                        $consulta = "SELECT * FROM Recepcionista WHERE Nombre LIKE '%$busqueda%' OR CURP LIKE '%$busqueda%'";
