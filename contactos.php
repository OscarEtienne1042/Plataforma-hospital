...
<html lang="en">
    ...
    <body>
      <header>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(./img/montaña.jpg);">
          <h1>Contactos</h1>
          <p>La mejor plataforma de atención médica</p>
