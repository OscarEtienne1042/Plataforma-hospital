...
<html lang="en">
    ...
    <body>
      <header>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item nav-item active" href="consultasMedicoI.php">Consultas individuales</a>
                  <!--
        ...
        <div class="cover d-flex justify-content-center align-items-center flex-column" style="background-image: url(./img/fondEight.jpg);">
            ...
            <form action="" method="get" class="container mt-5 mb-5">
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <input type="search" name="busqueda" placeholder="Busqueda de medicos..." id="busqueda" class="form-control"/>
                    </div>
            ...
            <div class="row justify-content-right">
                <?php
                    if(isset($_GET['enviar'])){
                        ...
                        $consulta = "SELECT * FROM Medico WHERE Nombre LIKE '%$busqueda%' OR CURP LIKE '%$busqueda%' OR Especialidad LIKE '%$busqueda%'";
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mt-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $fila['CURP']."<br> Especialidad: ".$fila['Especialidad']."<br> Contratación: ".$fila['Fecha_contratacion'].'<br><br>'?></p>
