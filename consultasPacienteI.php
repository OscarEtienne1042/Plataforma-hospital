            ...
            <form action="" method="get" class="container mt-5 mb-5">
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <input type="search" name="busqueda" placeholder="Busqueda de pacientes..." id="busqueda" class="form-control"/>
                    </div>
            ...
            <div class="row justify-content-right">
                <?php
                    if(isset($_GET['enviar'])){
                        ...
                        $consulta = "SELECT * FROM Paciente WHERE Nombre LIKE '%$busqueda%' OR CURP LIKE '%$busqueda%'";
