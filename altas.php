...
<html lang="en">
    ...
    <body>
      <header>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item nav-item active" href="altas.php">Altas</a>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(./img/fondTwo.jpg);">
          <h1>Agregar paciente</h1>
          <p>La mejor atención medica</p>
          <form action="consultasPaciente.php">
      ...
      <section>
        <div class="container mt-5 mb-5">
          ...
          <form class="container mt-5 mb-5" name="altaPaciente" method="post" action="php/AltaPaciente.php">
            <div class="form-row">
              <div class="form-group col-md-7">
                <label for="nombrePaciente">Nombre del paciente</label>
                <input type="text" name="namePaciente" class="form-control" id="nombrePaciente" placeholder="Nombre y apellidos" required>
              </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-5">
                ...
                <input type="tel" name="telefono" maxlength="" class="form-control" id="telefono" placeholder="+52 3310220201" required>
              </div>
            </div>
            <div class="form-row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="number" min="12" max="120" placeholder="Ingrese su edad" name="edad" id="edad" class="form-control" required>
              </div>  
            </div>
