...
<html lang="en">
    ...
    <body>
      <header>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item nav-item active" href="altasRecepcionista.php">Altas</a>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(./img/fondTen.jpg);">
          <h1>Agregar recepcionista</h1>
          <p>El mejor trabajo de la vida.</p>
          <form action="consultasRecepcionista.php">
      ...
      <section>
        <div class="container mt-5 mb-5">
          ...
          <form class="container mt-5 mb-5" name="altaRecepcionista" method="post" action="php/AltaRecepcionista.php">
            <div class="form-row">
              <div class="form-group col-md-7">
                <label for="nombreEmpleado">Nombre del empleado</label>
                <input type="text" name="nameEmpleado" class="form-control" id="nombreEmpleado" placeholder="Nombre y apellidos" required>
              </div>
